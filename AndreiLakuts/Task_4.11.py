...
def combine_dicts(*args):
    """combine_dicts(*args: dict)
    Function receives changeable number of dictionaries
    (keys - letters, values - numbers) and combines them into one dictionary.
    Dict values are summed in case of identical keys"""
    ...
    for dictionary in args:
        for key in dictionary:
            if key in output_dict:
                ...
                output_dict.update({key: dictionary[key]})
